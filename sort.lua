...
local function GetMount(itemName)
   local mountList = {};
   if main.faction == "Alliance" then
      mountList = { "Pinto Bridle", "Brown Horse Bridle", "Chestnut Mare Bridle", "Swift Brown Steed", "Swift Palomino",
         ...
         "Brown Ram", "Gray Ram", "White Ram", "Swift Brown Ram", "Swift Gray Ram", "Swift White Ram", "Swift Gray Ram",
      ...
      mountList = { "Horn of the", "Whistle of the", "Swift Blue Raptor", "Swift Olive Raptor", "Swift Orange Raptor",
         ...
         "Brown Kodo", "Gray Kodo", "Great White Kodo", "Black War Kodo", "Deathcharger's Reins", "Swift Razzashi Raptor",
   ...
   do
      ...
      do
         ...
         if itemID ~= nil then
            ...
            local itemName, _, itemRarity, itemLevel, _, itemType, itemSubType, _, _, _, _, e, enum = GetItemInfo(itemID);
...
local function TypeChecker(typeString)
   ...
   local types = { "Quest", "Consumable", "Weapon", "Armor", "Trade Goods", "Container", "Gem", "Key", "Money", "Reagent",
